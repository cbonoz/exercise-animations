...
const MOTIONS = {
  ...
  'pigeon-pose': {
    posture: 'seated',
    rest: { right_knee: { x: -15, y: -5 }, right_foot: { x: -80, y: 0 },
            left_knee: { x: 15, y: 5 }, left_foot: { x: 20, y: 0 } },
    move: { head: { x: -30, y: 5 }, neck: { x: -25, y: 3 }, shoulder: { x: -20, y: 3 },
            left_hand: { x: -25, y: 10 }, right_hand: { x: -25, y: 10 } },
    holdFrames: 36,
    highlight: [['hip','right_knee'],['right_knee','right_foot']],
    highlightColor: '#FF9500',
  },
  ...
  'worlds-greatest-stretch': {
    posture: 'lunge',
    move: { hip: { x: 5, y: -5 }, shoulder: { x: -10, y: -10 }, neck: { x: -12, y: -15 }, head: { x: -12, y: -18 },
            left_elbow: { x: 20, y: -40 }, left_hand: { x: 30, y: -60 },
            right_elbow: { x: 5, y: 15 }, right_hand: { x: 5, y: 25 } },
    highlight: [['shoulder','left_elbow'],['left_elbow','left_hand']],
    highlightColor: '#22C55E',
  },
  'thread-the-needle': {
    posture: 'all-fours',
    move: { left_hand: { x: 80, y: 15 }, shoulder: { x: 20, y: 20 }, hip: { x: -15, y: 5 },
            neck: { x: 15, y: 18 }, head: { x: 12, y: 15 },
            left_knee: { x: -10, y: 5 }, left_foot: { x: -10, y: 5 } },
  ...
  'standing-side-bend': {
    posture: 'standing',
    move: { head: { x: 22, y: 12 }, neck: { x: 18, y: 10 }, shoulder: { x: 14, y: 8 },
            right_elbow: { x: 12, y: -20 }, right_hand: { x: 18, y: -45 } },
    highlight: [['neck','shoulder'],['shoulder','hip']],
    highlightColor: '#22C55E',
  },
  'single-leg-stance': {
